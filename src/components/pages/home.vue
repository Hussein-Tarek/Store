  ...
  <div>
    ...
    <div class="bg-gray-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between py-12 md:py-20">
          <div class="mb-6 md:mb-0">
            <h1 class="text-3xl font-bold mb-2 text-gray-900">
              Discover the latest products
            </h1>
            <p class="text-gray-600">
              Shop our wide selection of items and find everything you need for
              your home.
            </p>
          </div>
          <div class="md:w-1/2">
    ...
    <div class="bg-white">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="mt-2 text-lg text-gray-600">
            Check out our handpicked selection of top-selling products.
          </p>
        </div>
        <div
          class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10"
        >
      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="mt-2 text-lg text-gray-600">
            Find what you're looking for in our wide selection of categories.
          </p>
        </div>
        <div
          class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10"
        >
